  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* HEADER PROFILE */}
        <div
            className="bg-neutral-950 border border-yellow-500/20 rounded-2xl p-8"
            >
            ...
            >
                ...
                <div
                className="relative w-36 h-36 rounded-full overflow-hidden border-4 border-yellow-500/20 shrink-0"
                >
                ...
                >
                    ...
                    <span
                    className="px-3 py-1 rounded-full bg-yellow-500/10 border border-yellow-500/20 text-yellow-300 text-sm"
                    >
